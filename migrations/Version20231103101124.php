 ...
 */
final class Version20231103101124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, address_category_id INT NOT NULL, user_address_id INT NOT NULL, user_id_id INT NOT NULL, phone_number VARCHAR(50) NOT NULL, address VARCHAR(255) NOT NULL, extended_address VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(20) NOT NULL, city VARCHAR(50) NOT NULL, country VARCHAR(50) NOT NULL, INDEX IDX_D4E6F81589BE29 (address_category_id), INDEX IDX_D4E6F8152D06999 (user_address_id), INDEX IDX_D4E6F819D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, address_id INT NOT NULL, address2_id INT NOT NULL, delivery_address_id INT NOT NULL, invoice_address_id INT NOT NULL, order_user_id INT NOT NULL, user_id_id INT NOT NULL, reference VARCHAR(255) NOT NULL, total_amount NUMERIC(10, 0) NOT NULL, order_date DATETIME NOT NULL, payment_status VARCHAR(255) NOT NULL, delivery_status VARCHAR(255) NOT NULL, INDEX IDX_F5299398F5B7AF75 (address_id), INDEX IDX_F5299398E443B061 (address2_id), INDEX IDX_F5299398EBF23851 (delivery_address_id), INDEX IDX_F5299398C6BDFEB (invoice_address_id), INDEX IDX_F529939851147ADE (order_user_id), INDEX IDX_F52993989D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, product_review_id INT NOT NULL, review_user_id INT NOT NULL, user_id_id INT NOT NULL, rating INT NOT NULL, comment LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_794381C6508E2016 (product_review_id), INDEX IDX_794381C63C806762 (review_user_id), INDEX IDX_794381C69D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, cart_user_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, account_status JSON NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D6495CB41B92 (cart_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6495CB41B92 FOREIGN KEY (cart_user_id) REFERENCES cart (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D6495CB41B92');
